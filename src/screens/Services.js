            ...
            <div class=" service-info pb-5">
                <div class="container">
                    ...
                    <div class="raw d-md-flex px-3 pt-3">
                        <div class="service-item col-12 col-md-6 col-lg-8 shadow border-start border-end  border-primary rounded-pill d-flex justify-content-center align-items-center">
                            <i class="fa-solid fa-circle-info rounded-pill"></i>
                            <p>You can get <br /> free information </p>
                        </div>
                        <div class="service-item col-12 col-md-6 col-lg-4  shadow border-start border-end border-primary rounded-pill d-flex justify-content-center align-items-center">
